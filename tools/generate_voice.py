...
SPEECH_STYLES = {
    ...
    "李纨": "表演成李纨：青年寡妇，温柔端庄、恬淡内敛，语速平缓，声音柔和不张扬，带一丝清苦和自持。",
    "薛宝钗": "表演成薛宝钗：年轻女性，温婉大方、沉稳得体，语气从容不迫，声音圆润饱满，有大家闺秀的气度。",
...
DIALOG_LINES = [
    ...
    ("visit_daoxiang", "旁白", "稻香村门前稻田青青，篱笆环绕，一派田园风光。李纨正坐在廊下做针线。"),
    ("visit_daoxiang_2", "刘姥姥", "哎呦！这地方跟我们乡下似的，看着就亲切！这稻子长得可真好！"),
    ("visit_daoxiang_3", "李纨", "姥姥请坐。这里虽简陋，倒也清净，正合我这寡居之人。"),
    ("visit_daoxiang_4", "刘姥姥", "姑娘这话说的！这叫雅致，哪叫简陋呢！我们乡下要是有这一半好，我做梦都能笑醒！"),
